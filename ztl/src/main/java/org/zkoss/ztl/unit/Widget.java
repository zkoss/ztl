...
public class Widget extends ClientWidget {
	...
	public void set(String name, boolean value) {
		Scripts.getEval("!!" + _out.toString() + toUpperCase(".set", name) + "(" + value + ")");
	}
	...
	public boolean is(String name) {
		return Boolean.valueOf(Scripts.getEval(_out.toString() + toUpperCase(".is", name) + "()"));
	}
	...
	public int nChildren() {
		return Integer.parseInt(Scripts.getEval(_out.toString() + ".nChildren"));
	}
	 ...
	 */
	public void detach() {
		Scripts.getEval(_out.toString() + ".detach()");
	}
	...
	public boolean exists() {
		return Boolean.valueOf(Scripts.getEval("!!" + _out.toString() + " && !!" + _out.toString() + ".$n()"));
	}
	...
	public String is_cafeStr(String name) {
		return Scripts.getCafeClientFunction(_out.toString() + toUpperCase(".is", name) + "()");
	}
	public String exists_cafeStr() {
		return Scripts.getCafeClientFunction("!!" + _out.toString() + " && !!" + _out.toString() + ".$n()");
	}
	public String nChildren_cafeStr() {
		return Scripts.getCafeClientFunction(_out.toString() + ".nChildren");
	}
}
