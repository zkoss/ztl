...
public class ZKClientTestCase extends ZKTestCase {
	 ...
	 * @category HasTouchScreen
	 */
	public void swipeUp(By locator, int distance) {
		WebDriver driver = getWebDriver();
		if (!(driver instanceof HasTouchScreen))
			throw new UnsupportedOperationException("device not touchable");
		
		WebElement toSwipe = driver.findElement(locator);
	 ...
	 * @category HasTouchScreen
	 */
	public void swipeDown(By locator, int distance) {
		WebDriver driver = getWebDriver();
		if (!(driver instanceof HasTouchScreen))
			throw new UnsupportedOperationException("device not touchable");
	 ...
	 * @category HasTouchScreen
	 */
	public void swipeLeft(By locator, int distance) {
		WebDriver driver = getWebDriver();
		if (!(driver instanceof HasTouchScreen))
			throw new UnsupportedOperationException("device not touchable");
	 ...
	 * @category HasTouchScreen
	 */
	public void swipeRight(By locator, int distance) {
		WebDriver driver = getWebDriver();
		if (!(driver instanceof HasTouchScreen))
			throw new UnsupportedOperationException("device not touchable");
